...
{
    const SurfaceTexture *surfaceTexture = surfaceItem->texture();
...
PlatformSurfaceTexture *SceneQPainter::createPlatformSurfaceTextureInternal(SurfaceTextureInternal *texture)
{
    return m_backend->createPlatformSurfaceTextureInternal(texture);
}

PlatformSurfaceTexture *SceneQPainter::createPlatformSurfaceTextureWayland(SurfaceTextureWayland *texture)
{
