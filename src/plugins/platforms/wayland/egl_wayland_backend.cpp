...
PlatformSurfaceTexture *EglWaylandBackend::createPlatformSurfaceTextureInternal(SurfaceTextureInternal *pixmap)
{
    return new BasicEGLSurfaceTextureInternal(this, pixmap);
}

PlatformSurfaceTexture *EglWaylandBackend::createPlatformSurfaceTextureWayland(SurfaceTextureWayland *pixmap)
{
