...
public:
    ...
    PlatformSurfaceTexture *createPlatformSurfaceTextureInternal(SurfaceTextureInternal *texture) override;
    PlatformSurfaceTexture *createPlatformSurfaceTextureWayland(SurfaceTextureWayland *texture) override;
...
{
public:
    EglStreamSurfaceTextureWayland(EglStreamBackend *backend, SurfaceTextureWayland *texture);
