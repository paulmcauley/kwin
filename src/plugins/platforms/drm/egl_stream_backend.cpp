...
PlatformSurfaceTexture *EglStreamBackend::createPlatformSurfaceTextureInternal(SurfaceTextureInternal *texture)
{
    return new BasicEGLSurfaceTextureInternal(this, texture);
}

PlatformSurfaceTexture *EglStreamBackend::createPlatformSurfaceTextureWayland(SurfaceTextureWayland *texture)
{
    return new EglStreamSurfaceTextureWayland(this, texture);
}
...
EglStreamSurfaceTextureWayland::EglStreamSurfaceTextureWayland(EglStreamBackend *backend,
    ...
    : BasicEGLSurfaceTextureWayland(backend, texture)
    , m_backend(backend)
{
}
