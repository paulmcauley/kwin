...
PlatformSurfaceTexture *EglX11Backend::createPlatformSurfaceTextureWayland(SurfaceTextureWayland *texture)
{
    return new BasicEGLSurfaceTextureWayland(this, texture);
}

PlatformSurfaceTexture *EglX11Backend::createPlatformSurfaceTextureInternal(SurfaceTextureInternal *texture)
{
