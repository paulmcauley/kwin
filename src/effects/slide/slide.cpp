...
SlideEffect::SlideEffect()
{
    ...
    connect(effects, &EffectsHandler::numberDesktopsChanged, this, &SlideEffect::numberDesktopsChanged);
    connect(effects, &EffectsHandler::numberScreensChanged, this, &SlideEffect::numberScreensChanged);
}
