...
{
template<class T> inline Effect *createHelper()
{
    return new T();
}
...
static const QVector<EffectData> &effectData()
{
    static const QVector<EffectData> s_effectData = {
        ...
        {QStringLiteral("coverswitch"),
         ...
         nullptr,
#endif
         EFFECT_FALLBACK QStringLiteral("kwin_coverswitch_config")},
        {QStringLiteral("cube"),
         ...
         nullptr,
#endif
         EFFECT_FALLBACK QStringLiteral("kwin_cube_config")},
        {QStringLiteral("cubeslide"),
         ...
         nullptr,
#endif
         EFFECT_FALLBACK QStringLiteral("kwin_cubeslide_config")},
        ...
        {QStringLiteral("flipswitch"),
         ...
         nullptr,
#endif
         EFFECT_FALLBACK QStringLiteral("kwin_flipswitch_config")},
