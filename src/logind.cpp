...
void LogindIntegration::logindServiceRegistered()
{
    ...
    QDBusMessage message = QDBusMessage::createMethodCall(m_sessionControllerService, m_sessionControllerPath, m_sessionControllerManagerInterface, methodName);
    ...
    connect(watcher, &QDBusPendingCallWatcher::finished, this, [this](QDBusPendingCallWatcher *self) {
        ...
        QDBusMessage message =
            QDBusMessage::createMethodCall(m_sessionControllerService, m_sessionPath, m_sessionControllerSessionInterface, QStringLiteral("Activate"));
        // blocking on purpose
        m_bus.call(message);
        getSeat();
        getSessionActive();
...
{
    m_bus.connect(m_sessionControllerService, m_sessionPath, s_dbusPropertiesInterface, QStringLiteral("PropertiesChanged"), this, SLOT(getSessionActive()));
    m_bus.connect(m_sessionControllerService, m_sessionPath, s_dbusPropertiesInterface, QStringLiteral("PropertiesChanged"), this, SLOT(getVirtualTerminal()));
}
...
void LogindIntegration::getSessionActive()
{
    ...
    QDBusMessage message = QDBusMessage::createMethodCall(m_sessionControllerService, m_sessionPath, s_dbusPropertiesInterface, QStringLiteral("Get"));
...
void LogindIntegration::takeControl()
{
    ...
    QDBusMessage message =
        QDBusMessage::createMethodCall(m_sessionControllerService, m_sessionPath, m_sessionControllerSessionInterface, QStringLiteral("TakeControl"));
...
void LogindIntegration::releaseControl()
{
    ...
    QDBusMessage message =
        QDBusMessage::createMethodCall(m_sessionControllerService, m_sessionPath, m_sessionControllerSessionInterface, QStringLiteral("ReleaseControl"));
...
int LogindIntegration::takeDevice(const char *path)
{
    ...
    QDBusMessage message =
        QDBusMessage::createMethodCall(m_sessionControllerService, m_sessionPath, m_sessionControllerSessionInterface, QStringLiteral("TakeDevice"));
...
void LogindIntegration::releaseDevice(int fd)
{
    ...
    if (fstat(fd, &st) < 0) {
        ...
        QDBusMessage message =
            QDBusMessage::createMethodCall(m_sessionControllerService, m_sessionPath, m_sessionControllerSessionInterface, QStringLiteral("ReleaseDevice"));
        message.setArguments(QVariantList({QVariant(major(st.st_rdev)), QVariant(minor(st.st_rdev))}));
        m_bus.asyncCall(message);
    }
    close(fd);
...
void LogindIntegration::switchVirtualTerminal(quint32 vtNr)
{
    ...
    QDBusMessage message = QDBusMessage::createMethodCall(m_sessionControllerService, m_seatPath, m_sessionControllerSeatInterface, QStringLiteral("SwitchTo"));
