...
// adjusted to XKB
static const std::map<xkb_keysym_t, Qt::Key> s_mapping{{XKB_KEY_Escape, Qt::Key_Escape},
...
static inline Qt::Key xkbToQtKey(xkb_keysym_t keySym)
{
    ...
    } else if ((keySym >= XKB_KEY_a && keySym <= XKB_KEY_z) || (keySym >= XKB_KEY_agrave && keySym < XKB_KEY_division)
