...
public:
     ...
     */
    template<typename T, typename Slot> void registerShortcut(const QKeySequence &shortcut, QAction *action, T *receiver, Slot slot);
     ...
     * bind.
     */
    template<class UnaryPredicate> void processFilters(UnaryPredicate function)
    {
     ...
     * bind.
     */
    template<class UnaryFunction> void processSpies(UnaryFunction function)
    {
...
template<typename T, typename Slot> inline void InputRedirection::registerShortcut(const QKeySequence &shortcut, QAction *action, T *receiver, Slot slot)
{
