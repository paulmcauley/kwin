...
void WaylandServer::registerXdgToplevelClient(XdgToplevelClient *client)
{
    ...
    auto it = std::find_if(m_plasmaShellSurfaces.begin(), m_plasmaShellSurfaces.end(), [surface](PlasmaShellSurfaceInterface *plasmaSurface) {
...
bool WaylandServer::init(InitializationFlags flags)
{
    ...
    connect(m_plasmaShell, &PlasmaShellInterface::surfaceCreated, [this](PlasmaShellSurfaceInterface *surface) {
    ...
    connect(m_appMenuManager, &AppMenuManagerInterface::appMenuCreated, [this](AppMenuInterface *appMenu) {
    ...
    connect(m_paletteManager, &ServerSideDecorationPaletteManagerInterface::paletteCreated, [this](ServerSideDecorationPaletteInterface *palette) {
