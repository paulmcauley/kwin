...
class KWIN_EXPORT SurfaceTextureX11 final : public SurfaceTexture
{
    Q_OBJECT

public:
    explicit SurfaceTextureX11(SurfaceItemX11 *item, QObject *parent = nullptr);
    ~SurfaceTextureX11() override;
