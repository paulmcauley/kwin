...
{
    static const auto stringMatchOptions = QList<RulePolicy::Data>{{Rules::UnimportantMatch, i18n("Unimportant")},
                                                                   {Rules::ExactMatch, i18n("Exact Match")},
                                                                   {Rules::SubstringMatch, i18n("Substring Match")},
                                                                   {Rules::RegExpMatch, i18n("Regular Expression")}};

    static const auto setRuleOptions =
        QList<RulePolicy::Data>{{Rules::Apply,
                                ...
                                {Rules::Force, i18n("Force"), i18n("The window property will be always forced to the given value.")},
